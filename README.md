...
|---|--------------|----------|-------|--------|
| 01 | Rogue Azure | CyberDefenders | Entra ID, Azure Storage Blobs, Service Principal abuse, Data exfiltration, KQL | Planned |
| 02 | DynamicEscalate | CyberDefenders | M365 UAL, Exchange Message Traces, Entra ID Privilege Escalation, KQL | Planned |
| 03 | AzureSpray | CyberDefenders | Azure AD Sign-in Logs, Sentinel Analytics, Password Spraying, Smart Lockout bypass | Planned |
